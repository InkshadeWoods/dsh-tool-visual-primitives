    ...
    factory: (require2) => {
      ...
      function normalizeState(raw) {
        ...
        return {
          ...
          ...Object.fromEntries(PERSISTED_KEYS.map((key) => [key, persisted[key]]).filter(([, value]) => value !== void 0 && value !== null)),
          apiKey: "",
      ...
      function getCredentialApi(ctx) {
        ...
        const settle = (res, okShape, message) => {
          ...
          return { ok, error: ok ? void 0 : res?.error?.message || res?.result?.error?.message || message };
        };
        return {
          async set(ref, value) {
            try {
              const res = isRemote ? await backend.set(ref, value) : await backend.set({ ref, value });
          ...
          async unset(ref) {
            try {
              const res = isRemote ? await backend.unset(ref) : await backend.unset({ ref });
          ...
          async describe(refs) {
            try {
              const res = isRemote ? await backend.describe(refs) : await backend.describe({ refs });
      ...
      async function syncCredentials(api, state, touchedKeys) {
        ...
        for (const [ref, value, key] of entries) {
          ...
          const response = trimmed ? await api.set(ref, trimmed) : await api.unset(ref);
          if (!response?.ok) {
                    ...
                    children: [
                      /* @__PURE__ */ reactJsxRuntime.jsxs("span", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ reactJsxRuntime.jsx("span", {
                            style: { fontSize: 12, color: "var(--dsw-alias-label-tertiary, #888)" },
                            children: providerEnabledCount > 0 ? `${providerBridgableCount} \u4E2A\u6A21\u578B\u53EF\u589E\u5F3A \xB7 \u5DF2\u542F\u7528 ${providerEnabledCount} \u4E2A` : `${providerBridgableCount} \u4E2A\u6A21\u578B\u53EF\u589E\u5F3A`
                          })
                        ]
                      }),
                      /* @__PURE__ */ reactJsxRuntime.jsx("span", {
                    ...
                    children: models.map((model) => {
                      ...
                      return /* @__PURE__ */ reactJsxRuntime.jsxs("label", {
                        ...
                        children: [
                          ...
                          nativeVision && /* @__PURE__ */ reactJsxRuntime.jsx("span", {
                            style: { color: "var(--dsw-alias-label-tertiary, #888)", fontSize: 12 },
                            children: "\xB7 \u81EA\u5E26\u56FE\u7247\u652F\u6301\uFF0C\u65E0\u9700\u589E\u5F3A"
                          })
                        ]
                      }, key);
                    })
